...
a persistence unit "examen63panoraPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examen63panora/pom.xml":
...
artifact ("examen63panora.war") is already built. You can build
